...
<%@page import="com.tshirtosaurus.beans.Constants"%>
...
<body style="background-color:#FFFFFF;background-image:url(xbackground.gif);background-repeat:no-repeat;background-position: center; ">
